...
export default function App() {
  ...
  if (currentScene === 'intro') {
    return (
      <div 
        className="min-h-screen text-white font-sans flex flex-col items-center justify-center p-6 relative overflow-hidden scanline-overlay bg-zinc-950 cursor-pointer"
        onClick={() => { if (!videoEnded) setVideoEnded(true); }}
      >
